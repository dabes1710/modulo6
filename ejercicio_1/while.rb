...
# ingrese palabras, estas deberán ser devueltas al usuario con un texto "dijiste: ...", 
# hasta que el usuario escriba salir
# Ejemplo

# hola => dijiste: hola 🦜 ¿me estas imitando 😠? 
...
# de números, sumarlas y al final para salir el usuario deberá escribir -1. El programa también deberá controlar que no ingrese texto mezclado con los números. (se puede utilizar "texto".to_i para apoyarse en alguna validación)

# Ejemplo

# => Ingrese sus ventas del día 5000 6000 1000 650ss => 650ss no es un 
#número 🧨 -1 => Las ventas del día fueron 12000 💵
