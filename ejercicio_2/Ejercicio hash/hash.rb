...
# Crear un archivo dentro de la carpeta ejercicio2 llamado ejercicios_hash.rb 
# para realizar los siguientes ejercicios
# Utilizando los 10 diccionarios que se encuentran en la parte inferior 
# realizar los siguientes ejercicios.
# Definir un menú que permita al usuario visualizar el nombre del estadio
# dependiendo el país que ingrese por consola.
# Solicitar al usuario a través de un menú que seleccione 2 países utilizando 
...
# Definir un arreglo de equipos y agregar todos los hash declarados 
...
puts "ingrese el numero del pais visitante"
visita= gets.chomp.to_i

partido = {}
partido[:local] = equipos[local-1] [:nombre]
partido[:visitante] = equipos[visita-1] [:nombre]
partido[:estadio] = equipos[local-1] [:nombre]

puts partido

#ejercicios resueltos rene
equipo1 = { nombre:     'argentina',    estadio: 'Estadio Único de Santiago del Estero' }
